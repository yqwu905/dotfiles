...
export ZSH="/home/yqwu/.oh-my-zsh"
...
export WIN_PORT=34567
sed -i '/\[ProxyList\]/,$d' ~/.proxychains.conf
echo '[ProxyList]\nsocks5 '${WIN_IP}' '${WIN_PORT}'' >> ~/.proxychains.conf
alias pc='proxychains4 -q -f ~/.proxychains.conf'
git config --global http.proxy 'socks5://'${WIN_IP}':'${WIN_PORT}''
git config --global https.proxy 'socks5://'${WIN_IP}':'${WIN_PORT}''

alias gs='git status'

export PATH=$PATH:/home/yqwu/tools/
export PATH=$PATH:/home/yqwu/tools/efm
