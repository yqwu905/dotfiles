...
function config.mason_installer()
  require('mason-tool-installer').setup({
      ensure_installed = { 'lua-language-server', 'rust-analyzer', 'clangd',
          'cmake-language-server', 'html-lsp', 'json-lsp', 'julia-lsp',
          'texlab', 'marksman', 'jedi-language-server', 'taplo',
          'yaml-language-server', 'yapf', 'flake8', 'actionlint', 'cpplint',
          'cpptools', 'codelldb'}
  })
end
